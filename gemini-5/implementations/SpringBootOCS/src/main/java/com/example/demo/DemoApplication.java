...
public class DemoApplication {
    ...
    public static void updateSciencePlanStatus() {
        ...
        ocs.updateSciencePlanStatus(2, SciencePlan.STATUS.SUBMITTED);
        System.out.println(ocs.getSciencePlanByNo(2));
    
        ocs.updateSciencePlanStatus(3, SciencePlan.STATUS.SUBMITTED);
        System.out.println(ocs.getSciencePlanByNo(3));

        ocs.updateSciencePlanStatus(4, SciencePlan.STATUS.SUBMITTED);
